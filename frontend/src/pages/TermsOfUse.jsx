    ...
    <div className="bg-light w-full h-hfull flex flex-col items-center justify-center pt-5 font-pops">
      ...
      <div className="bg-white w-[80%] rounded-md p-5 text-lg">
        <p>
          ...
          1. <span className="font-semibold">Accurate Information</span> <br />
          ...
          3. <span className="font-semibold">Compliance with Laws</span> <br />
          ...
          <br />
          4. <span className="font-semibold">Prohibited Activities</span> <br />
          ...
          <br />
          Acknowledge that all content, trademarks, and intellectual property on
          our platform are owned by YourGross or our licensors. Do not use,
          ...
          its conflict of law principles. By using our platform, you agree that
          any disputes arising out of or relating to these terms, your access to
          or use of our services, or any related matters shall be subject to the
          exclusive jurisdiction of the courts of Antipolo. You consent to the
          personal jurisdiction of such courts and waive any objections to their
          jurisdiction. Additionally, any claims or causes of action must be
          brought within one (1) year after the claim arises, or such claims
          will be barred. By using our services, you acknowledge that you have
          read and understood this Governing Law section and agree to its terms.
        </p>
      </div>
